 ...
 */
class getSpotbooksRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SpotbooksRepository' shared autowired service.
     *
     * @return \App\Repository\SpotbooksRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SpotbooksRepository.php';

        return $container->privates['App\\Repository\\SpotbooksRepository'] = new \App\Repository\SpotbooksRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
