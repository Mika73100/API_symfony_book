 ...
 */
class getBorrowBookRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BorrowBookRepository' shared autowired service.
     *
     * @return \App\Repository\BorrowBookRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BorrowBookRepository.php';

        return $container->privates['App\\Repository\\BorrowBookRepository'] = new \App\Repository\BorrowBookRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
